...
As it turns out, the group $mathbb{Z}(N)$ plays an important part in the theory of the discrete Fourier transform, and acts as a weight for storing information on the unit circle given a specific periodic function. 
